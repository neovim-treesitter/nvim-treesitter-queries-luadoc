# nvim-treesitter-queries-luadoc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-luadoc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-luadoc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **luadoc**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-luadoc",
...
- [ ] Changes are scoped to `luadoc` — do not include files for other languages
